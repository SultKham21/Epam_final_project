...
<head>
    ...
    <title><fmt:message key="title.update_restaurant_city"/></title>
</head>
<body>
...
<h1><fmt:message key="title.update_restaurant_city"/></h1>
<form action="${pageContext.request.contextPath}/controller?command=updating_restaurant_city" method="post">
    <c:if test="${requestScope.updatingRestaurantCityError != null}">
        <div class="error"><fmt:message key="error.restaurant_city"/></div>
    </c:if>
