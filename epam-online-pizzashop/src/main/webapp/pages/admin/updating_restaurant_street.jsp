...
<head>
    ...
    <title><fmt:message key="title.update_restaurant_street"/></title>
</head>
<body>
...
<h1><fmt:message key="title.update_restaurant_street"/></h1>
<form action="${pageContext.request.contextPath}/controller?command=updating_restaurant_street" method="post">
    <c:if test="${requestScope.updatingRestaurantStreetError != null}">
        <div class="error"><fmt:message key="error.restaurant_street"/></div>
    </c:if>
