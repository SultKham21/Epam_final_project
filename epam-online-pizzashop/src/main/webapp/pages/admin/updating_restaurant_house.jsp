...
<head>
    ...
    <title><fmt:message key="title.update_restaurant_house"/></title>
</head>
<body>
...
<h1><fmt:message key="title.update_restaurant_house"/></h1>
<form action="${pageContext.request.contextPath}/controller?command=updating_restaurant_house" method="post">
    <c:if test="${requestScope.updatingRestaurantHouseError != null}">
        <div class="error"><fmt:message key="error.restaurant_house"/></div>
    </c:if>
