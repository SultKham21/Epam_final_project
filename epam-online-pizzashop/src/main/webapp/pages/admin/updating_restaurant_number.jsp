...
<head>
    ...
    <title><fmt:message key="title.update_restaurant_number"/></title>
</head>
<body>
...
<h1><fmt:message key="title.update_restaurant_number"/></h1>
<form action="${pageContext.request.contextPath}/controller?command=updating_restaurant_number" method="post">
    <c:if test="${requestScope.updatingRestaurantNumberError != null}">
