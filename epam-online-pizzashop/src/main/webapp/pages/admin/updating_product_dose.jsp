...
<head>
    ...
    <title><fmt:message key="title.update_product_waight"/></title>
</head>
<body>
...
<h1><fmt:message key="title.update_product_waight"/></h1>
<form action="${pageContext.request.contextPath}/controller?command=updating_product_dose" method="post">
    ...
    <input type="text" name="newDose" placeholder="<fmt:message key="placeholder.new_waight"/>"/><br>
    <input type="submit" value="<fmt:message key="button.update_waight"/>" class="button_product_update"/>
</form>
