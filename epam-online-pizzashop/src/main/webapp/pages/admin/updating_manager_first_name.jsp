...
<head>
    ...
    <title><fmt:message key="title.update_manager_first_name"/></title>
</head>
<body>
...
<h1><fmt:message key="title.update_manager_first_name"/></h1>
<form action="${pageContext.request.contextPath}/controller?command=updating_manager_first_name" method="post">
    <c:if test="${requestScope.updatingmanagerFirstNameError != null}">
