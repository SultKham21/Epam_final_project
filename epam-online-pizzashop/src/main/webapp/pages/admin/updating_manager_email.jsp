...
<head>
    ...
    <title><fmt:message key="title.update_manager_email"/></title>
</head>
<body>
...
<h1><fmt:message key="title.update_manager_email"/></h1>
<form action="${pageContext.request.contextPath}/controller?command=updating_manager_email" method="post">
    <c:if test="${requestScope.updatingmanagerEmailError != null}">
